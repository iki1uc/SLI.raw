...
🔷 SLI — Der Motor
SLI ist keine Datei, sondern eine Funktion:
...
SLI‑LOCHER → Schnittpunkt WLOCH/SLOCH/SLI
...
Stellt die SLI‑Position bereit (IX / XI / neutral).

SCHACH.js
Positionslogik:
alpha / beta / gamma rotieren dynamisch über TMP.
Axiom 1–2–3 wechselt ständig.
